export function Footer2() {
  return (
    <footer className="border-t border-white/10 bg-[#030303]" aria-label="Footer">
      <div className="brand-container grid gap-10 py-12 sm:py-16 lg:grid-cols-[1fr_1.15fr] lg:gap-20">
        <div>
          <div className="text-[clamp(2.4rem,8vw,5.8rem)] font-black uppercase leading-[0.82] tracking-[-0.075em]">UNPROFITABLE</div>
          ...
          <p className="mt-8 max-w-2xl text-xs leading-6 text-white/42">
        ...
        <div className="grid grid-cols-2 gap-7 sm:grid-cols-4">
          <FooterGroup title="Drop" links={[['Drop 001', '#drop'], ['Hoodie', '/products/disciplined-heavyweight-hoodie.html'], ['Tee', '/products/disciplined-oversized-tee.html'], ['Hat', '/products/disciplined-structured-hat.html']]} />
          <FooterGroup title="Brand" links={[['Manifesto', '#top'], ['Proof', '#proof'], ['Access', '#join']]} />

...
import mobileHeroWebp from '../../assets/images/hero/mobile-hero-disciplined-hoodie-editorial.webp';
import mobileHeroJpg from '../../assets/images/hero/mobile-hero-disciplined-hoodie-editorial.jpg';
    ...
    <section id="top" className="unp-hero relative isolate overflow-hidden bg-black pt-5 sm:pt-10 lg:min-h-[calc(100svh-72px)]">
      ...
      <div className="brand-container unp-hero-grid grid gap-4 pb-14 md:grid-cols-[0.9fr_1.1fr] md:items-end md:gap-0 lg:pb-20">
        ...
        <motion.figure
          ...
          className="hero-model relative z-30 order-2 mx-auto -mt-1 grid w-full max-w-[390px] min-w-0 place-items-center md:-ml-5 md:mt-0 md:max-w-[630px] lg:-ml-10 lg:max-w-[720px]"
        ...
        >
          ...
          <picture className="hero-model-picture relative block w-full overflow-hidden drop-shadow-[0_38px_62px_rgba(0,0,0,.82)] sm:overflow-visible md:translate-x-2 lg:translate-x-4">
            ...
            <source media="(max-width: 767px)" srcSet={mobileHeroJpg} type="image/jpeg" />
            ...
            <img
              ...
              className="mx-auto aspect-[4/5] h-auto w-full object-cover object-[50%_34%] contrast-[1.04] saturate-0 sm:aspect-auto sm:object-contain sm:object-center"
              decoding="async"
              fetchPriority="high"
            />
          </picture>
